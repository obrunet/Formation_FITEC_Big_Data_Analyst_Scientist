...
package talenddemo.jobdemo_0_1;
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String messagetMsgBox_1 = "Hello world Talend!!! bienvenue";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jobdemo.class.getClassLoader()
					.getResourceAsStream("talenddemo/jobdemo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 24152 characters generated by Talend Open Studio for Data Integration on the
 * 18 novembre 2019 à 12:11:59 CET
 ************************************************************************************************/