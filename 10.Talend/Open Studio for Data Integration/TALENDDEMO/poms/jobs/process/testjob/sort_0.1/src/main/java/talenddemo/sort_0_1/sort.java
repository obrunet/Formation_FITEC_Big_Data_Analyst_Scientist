 ...
 * @status 
 */
public class sort implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "sort";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(sort.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_TALENDDEMO_sort = new byte[0];
    static byte[] commonByteArray_TALENDDEMO_sort = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TALENDDEMO_sort.length) {
				if(length < 1024 && commonByteArray_TALENDDEMO_sort.length == 0) {
   					commonByteArray_TALENDDEMO_sort = new byte[1024];
				} else {
   					commonByteArray_TALENDDEMO_sort = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TALENDDEMO_sort, 0, length);
			strReturn = new String(commonByteArray_TALENDDEMO_sort, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TALENDDEMO_sort) {
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("ENC:[hpWZ8qmQIk2/nEgYcCiqT06CXY4HaLiu1Uzs2w==]");
		...
		Object source_tFileInputExcel_1 = "/home/fitec/Talend/workspace/sort.xlsx";
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "letter";

				row1.letter = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.letter = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
if(row1 != null) { 
	...
	arrayRowtSortRow_1_SortOut.letter = row1.letter;	
 ...
 */
	...
	String originalFileName_tFileOutputXML_1 = "/home/fitec/Talend/workspace/out_sort.xml";
...
for(int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++){
	...
	row2.letter = current_tSortRow_1_SortIn.letter;
...
out_tFileOutputXML_1.newLine();
out_tFileOutputXML_1.write("<"+"id"+">"+((row3.id == null)?"":(row3.id))+"</"+"id"+">");

out_tFileOutputXML_1.newLine();
out_tFileOutputXML_1.write("<"+"letter"+">"+((row3.letter == null)?"":(TalendString.checkCDATAForXML(row3.letter)))+"</"+"letter"+">");
 ...
 */
    ...
    public static void main(String[] args){
        final sort sortClass = new sort();

        int exitCode = sortClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = sort.class.getClassLoader().getResourceAsStream("talenddemo/sort_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = sort.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sort");
        }
...
/************************************************************************************************
 *     63389 characters generated by Talend Open Studio for Data Integration 
 *     on the 19 novembre 2019 à 15:07:18 CET
 ************************************************************************************************/