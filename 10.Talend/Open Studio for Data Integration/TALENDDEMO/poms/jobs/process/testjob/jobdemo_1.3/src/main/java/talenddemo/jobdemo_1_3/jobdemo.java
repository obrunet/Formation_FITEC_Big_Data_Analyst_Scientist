...
package talenddemo.jobdemo_1_3;
...
/**
 * Job: jobdemo Purpose: premier test de job<br>
 * Description: ceci est un test du job non requis mais bonne pratique <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status
 */
public class jobdemo implements TalendJob {
	...
	private final String jobName = "jobdemo";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jobdemo.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				int messageIcontMsgBox_1 = javax.swing.JOptionPane.ERROR_MESSAGE;
				String titletMsgBox_1 = "Talend Open Studio";
				String messagetMsgBox_1 = "Hello world Talend!!! bienvenue version 1.3";
	...
	public static void main(String[] args) {
		final jobdemo jobdemoClass = new jobdemo();

		int exitCode = jobdemoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jobdemo.class.getClassLoader()
					.getResourceAsStream("talenddemo/jobdemo_1_3/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jobdemo.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : jobdemo");
		}
...
/************************************************************************************************
 * 24162 characters generated by Talend Open Studio for Data Integration on the
 * 18 novembre 2019 à 12:28:24 CET
 ************************************************************************************************/