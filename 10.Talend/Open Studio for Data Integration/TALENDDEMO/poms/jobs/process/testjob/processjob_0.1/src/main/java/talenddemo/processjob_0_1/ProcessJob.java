...
package talenddemo.processjob_0_1;
 ...
 * @status
 */
public class ProcessJob implements TalendJob {
	...
	private final String jobName = "ProcessJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ProcessJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TALENDDEMO_ProcessJob = new byte[0];
		static byte[] commonByteArray_TALENDDEMO_ProcessJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDDEMO_ProcessJob.length) {
					if (length < 1024 && commonByteArray_TALENDDEMO_ProcessJob.length == 0) {
						commonByteArray_TALENDDEMO_ProcessJob = new byte[1024];
					} else {
						commonByteArray_TALENDDEMO_ProcessJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDDEMO_ProcessJob, 0, length);
				strReturn = new String(commonByteArray_TALENDDEMO_ProcessJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDDEMO_ProcessJob) {
	...
	public void tFileInputDelimited_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "identifiant", "nom", "prenom", "ville", "etat", });
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "/home/fitec/Talend/workspace/utilisateurs.csv";
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											...
											"identifiant", "row1", temp, ex_tFileInputDelimited_3),
							...
							row1.etat = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"salaire", "row1", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final ProcessJob ProcessJobClass = new ProcessJob();

		int exitCode = ProcessJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ProcessJob.class.getClassLoader()
					.getResourceAsStream("talenddemo/processjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ProcessJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProcessJob");
		}
...
/************************************************************************************************
 * 49045 characters generated by Talend Open Studio for Data Integration on the
 * 21 novembre 2019 à 10:08:01 CET
 ************************************************************************************************/