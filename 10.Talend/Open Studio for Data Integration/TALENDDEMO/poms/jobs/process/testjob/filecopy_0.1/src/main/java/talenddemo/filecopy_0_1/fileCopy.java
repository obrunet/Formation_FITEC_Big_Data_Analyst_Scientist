...
package talenddemo.filecopy_0_1;
 ...
 * @status
 */
public class fileCopy implements TalendJob {
	...
	private final String jobName = "fileCopy";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(fileCopy.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tFileCopy_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String srcFileName_tFileCopy_1 = "/home/fitec/Talend/workspace/exos_talend.docx";
				...
				String desDirName_tFileCopy_1 = "/home/fitec/Talend/workspace/destination_folder";

				String desFileName_tFileCopy_1 = "NewName.temp";
	...
	public static void main(String[] args) {
		final fileCopy fileCopyClass = new fileCopy();

		int exitCode = fileCopyClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = fileCopy.class.getClassLoader()
					.getResourceAsStream("talenddemo/filecopy_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = fileCopy.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : fileCopy");
		}
...
/************************************************************************************************
 * 25534 characters generated by Talend Open Studio for Data Integration on the
 * 19 novembre 2019 à 10:21:01 CET
 ************************************************************************************************/