 ...
 * @status
 */
public class TP1 implements TalendJob {
	...
	private final String jobName = "TP1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TP1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tFileUnarchive_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String zipFileURL_tFileUnarchive_1 = "/home/fitec/Talend/workspace/exos_talend.zip";
				String tmpFileURL_tFileUnarchive_1 = zipFileURL_tFileUnarchive_1.toLowerCase();
				String outputPath_tFileUnarchive_1 = "/home/fitec/Talend/workspace";
				...
				if (tmpFileURL_tFileUnarchive_1.endsWith(".tar.gz") || tmpFileURL_tFileUnarchive_1.endsWith(".tgz")) {
					...
					final String decryptedPassword_tFileUnarchive_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("ENC:[J46feJY7pcttrTppy4mltG2192AtnBoubWYlPA==]");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALENDDEMO_TP1 = new byte[0];
		static byte[] commonByteArray_TALENDDEMO_TP1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDDEMO_TP1.length) {
					if (length < 1024 && commonByteArray_TALENDDEMO_TP1.length == 0) {
						commonByteArray_TALENDDEMO_TP1 = new byte[1024];
					} else {
						commonByteArray_TALENDDEMO_TP1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDDEMO_TP1, 0, length);
				strReturn = new String(commonByteArray_TALENDDEMO_TP1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDDEMO_TP1) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"/home/fitec/Talend/workspace/comparison_result.csv")).getAbsolutePath().replace("\\", "/");
				...
				if (result_tFileCompare_1) {
					...
					java.io.BufferedReader file_tFileCompare_1 = new java.io.BufferedReader(
							new java.io.InputStreamReader(new java.io.FileInputStream(
									"/home/fitec/Talend/workspace/exos_talend_original.docx"), "ISO-8859-15"));
					java.io.BufferedReader fileRef_tFileCompare_1 = new java.io.BufferedReader(
							new java.io.InputStreamReader(
									new java.io.FileInputStream("/home/fitec/Talend/workspace/exos_talend.docx"),
									"ISO-8859-15"));
				...
				row1.file = "/home/fitec/Talend/workspace/exos_talend_original.docx";
				row1.file_ref = "/home/fitec/Talend/workspace/exos_talend.docx";
				row1.moment = java.util.Calendar.getInstance().getTime();
				row1.job = jobName;
				row1.component = currentComponent;
				row1.differ = (result_tFileCompare_1) ? 0 : 1;
				row1.message = messagetFileCompare_1;
				...
				if (row1.file != null) {
					sb_tFileOutputDelimited_1.append(row1.file);
				}
				sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
				if (row1.file_ref != null) {
					sb_tFileOutputDelimited_1.append(row1.file_ref);
				}
				sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
				if (row1.moment != null) {
					sb_tFileOutputDelimited_1.append(FormatterUtils.format_Date(row1.moment, "yyyy-MM-dd HH:mm:ss"));
				}
				sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
				if (row1.job != null) {
					sb_tFileOutputDelimited_1.append(row1.job);
				}
				sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
				if (row1.component != null) {
					sb_tFileOutputDelimited_1.append(row1.component);
				}
				sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
				if (row1.differ != null) {
					sb_tFileOutputDelimited_1.append(row1.differ);
				}
				sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
				if (row1.message != null) {
					sb_tFileOutputDelimited_1.append(row1.message);
				}
	...
	public static void main(String[] args) {
		final TP1 TP1Class = new TP1();

		int exitCode = TP1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TP1.class.getClassLoader()
					.getResourceAsStream("talenddemo/tp1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = TP1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TP1");
		}
...
/************************************************************************************************
 * 50333 characters generated by Talend Open Studio for Data Integration on the
 * 19 novembre 2019 à 11:15:37 CET
 ************************************************************************************************/