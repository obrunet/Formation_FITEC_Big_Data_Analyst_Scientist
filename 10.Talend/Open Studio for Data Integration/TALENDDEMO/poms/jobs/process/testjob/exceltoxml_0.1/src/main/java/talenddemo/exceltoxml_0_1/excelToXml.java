...
package talenddemo.exceltoxml_0_1;
 ...
 * @status
 */
public class excelToXml implements TalendJob {
	...
	private final String jobName = "excelToXml";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excelToXml.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TALENDDEMO_excelToXml = new byte[0];
		static byte[] commonByteArray_TALENDDEMO_excelToXml = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDDEMO_excelToXml.length) {
					if (length < 1024 && commonByteArray_TALENDDEMO_excelToXml.length == 0) {
						commonByteArray_TALENDDEMO_excelToXml = new byte[1024];
					} else {
						commonByteArray_TALENDDEMO_excelToXml = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDDEMO_excelToXml, 0, length);
				strReturn = new String(commonByteArray_TALENDDEMO_excelToXml, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDDEMO_excelToXml) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String originalFileName_tFileOutputXML_1 = "/home/fitec/Talend/out.xml";
				...
				util_tLogRow_1.addRow(new String[] { "newColumn", "newColumn1", });
...
///////////////////////    			
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[AcjlVeljzWjE1AoyJnzpS7W9VnAxI5/A951QWA==]");
				...
				Object source_tFileInputExcel_1 = "/home/fitec/Talend/excel_file.xlsx";
...
///////////////////////    			
								...
								out_tFileOutputXML_1.newLine();
								out_tFileOutputXML_1.write("<" + "newColumn" + ">"
										+ ((row2.newColumn == null) ? ""
												: (TalendString.checkCDATAForXML(row2.newColumn)))
										+ "</" + "newColumn" + ">");

								out_tFileOutputXML_1.newLine();
								out_tFileOutputXML_1.write("<" + "newColumn1" + ">"
										+ ((row2.newColumn1 == null) ? ""
												: (TalendString.checkCDATAForXML(row2.newColumn1)))
										+ "</" + "newColumn1" + ">");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final excelToXml excelToXmlClass = new excelToXml();

		int exitCode = excelToXmlClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = excelToXml.class.getClassLoader()
					.getResourceAsStream("talenddemo/exceltoxml_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excelToXml.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : excelToXml");
		}
...
/************************************************************************************************
 * 53612 characters generated by Talend Open Studio for Data Integration on the
 * 19 novembre 2019 à 09:38:18 CET
 ************************************************************************************************/