...
package talenddemo.filearchive_0_1;
...
/**
 * Job: fileArchive Purpose: test file archive<br>
 * Description: test file archive <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status
 */
public class fileArchive implements TalendJob {
	...
	private final String jobName = "fileArchive";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(fileArchive.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tFileArchive_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String sourceFile_tFileArchive_1 = "/home/fitec/Talend/workspace";
				...
				String zipFile_tFileArchive_1 = "/home/fitec/Documents/test.zip";
				...
				final String decryptedPassword_tFileArchive_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[YxAyxRESjg39oHbbHbbV7F3t+SMA8rVzw0Vn2w==]");
	...
	public static void main(String[] args) {
		final fileArchive fileArchiveClass = new fileArchive();

		int exitCode = fileArchiveClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = fileArchive.class.getClassLoader()
					.getResourceAsStream("talenddemo/filearchive_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = fileArchive.class.getClassLoader()
		...
		} catch (TalendException e_tFileArchive_1) {
			globalMap.put("tFileArchive_1_SUBPROCESS_STATE", -1);

			e_tFileArchive_1.printStackTrace();
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : fileArchive");
		}
...
/************************************************************************************************
 * 25551 characters generated by Talend Open Studio for Data Integration on the
 * 18 novembre 2019 à 14:23:23 CET
 ************************************************************************************************/