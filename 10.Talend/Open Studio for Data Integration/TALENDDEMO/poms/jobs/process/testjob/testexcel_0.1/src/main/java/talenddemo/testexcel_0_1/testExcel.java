...
package talenddemo.testexcel_0_1;
 ...
 * @status
 */
public class testExcel implements TalendJob {
	...
	private final String jobName = "testExcel";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(testExcel.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALENDDEMO_testExcel = new byte[0];
		static byte[] commonByteArray_TALENDDEMO_testExcel = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDDEMO_testExcel.length) {
					if (length < 1024 && commonByteArray_TALENDDEMO_testExcel.length == 0) {
						commonByteArray_TALENDDEMO_testExcel = new byte[1024];
					} else {
						commonByteArray_TALENDDEMO_testExcel = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDDEMO_testExcel, 0, length);
				strReturn = new String(commonByteArray_TALENDDEMO_testExcel, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDDEMO_testExcel) {
...
///////////////////////    			
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[RIVOPFywqQsmCdoG8oDmkHdnM3GvtGEpjlr4Ng==]");
				...
				Object source_tFileInputExcel_1 = "/home/fitec/Documents/test_talend.xlsx";
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final testExcel testExcelClass = new testExcel();

		int exitCode = testExcelClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = testExcel.class.getClassLoader()
					.getResourceAsStream("talenddemo/testexcel_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = testExcel.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : testExcel");
		}
...
/************************************************************************************************
 * 42408 characters generated by Talend Open Studio for Data Integration on the
 * 18 novembre 2019 à 15:44:32 CET
 ************************************************************************************************/