...
package talenddemo.remla_job_0_1;
 ...
 * @status
 */
public class remla_job implements TalendJob {
	...
	private final String jobName = "remla_job";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(remla_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TALENDDEMO_remla_job = new byte[0];
		static byte[] commonByteArray_TALENDDEMO_remla_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDDEMO_remla_job.length) {
					if (length < 1024 && commonByteArray_TALENDDEMO_remla_job.length == 0) {
						commonByteArray_TALENDDEMO_remla_job = new byte[1024];
					} else {
						commonByteArray_TALENDDEMO_remla_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDDEMO_remla_job, 0, length);
				strReturn = new String(commonByteArray_TALENDDEMO_remla_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDDEMO_remla_job) {
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.salaire = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							String searchStr_tReplace_1_1 = "4000" + "";
							row1.salaire = StringUtils.replaceAllStrictly(row1.salaire, searchStr_tReplace_1_1,
									"4100" + "", true, false);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final remla_job remla_jobClass = new remla_job();

		int exitCode = remla_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = remla_job.class.getClassLoader()
					.getResourceAsStream("talenddemo/remla_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = remla_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : remla_job");
		}
...
/************************************************************************************************
 * 49375 characters generated by Talend Open Studio for Data Integration on the
 * 21 novembre 2019 à 11:21:18 CET
 ************************************************************************************************/