...
package talenddemo.testfileunarchie_0_1;
...
/**
 * Job: testFileUnarchie Purpose: the opposite<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class testFileUnarchie implements TalendJob {
	...
	private final String jobName = "testFileUnarchie";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					testFileUnarchie.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(testFileUnarchie.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tFileUnarchive_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String zipFileURL_tFileUnarchive_1 = "/home/fitec/Documents/test.zip";
				String tmpFileURL_tFileUnarchive_1 = zipFileURL_tFileUnarchive_1.toLowerCase();
				String outputPath_tFileUnarchive_1 = "/home/fitec/Documents/";
				...
				if (tmpFileURL_tFileUnarchive_1.endsWith(".tar.gz") || tmpFileURL_tFileUnarchive_1.endsWith(".tgz")) {
					...
					final String decryptedPassword_tFileUnarchive_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("ENC:[VMeZB1KAqlMVbIwG+ea8La270b0qIwSZigZKwQ==]");
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String messagetMsgBox_1 = "The archive has been unzipped!";
	...
	public static void main(String[] args) {
		final testFileUnarchie testFileUnarchieClass = new testFileUnarchie();

		int exitCode = testFileUnarchieClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = testFileUnarchie.class.getClassLoader()
					.getResourceAsStream("talenddemo/testfileunarchie_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = testFileUnarchie.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : testFileUnarchie");
		}
...
/************************************************************************************************
 * 34054 characters generated by Talend Open Studio for Data Integration on the
 * 18 novembre 2019 à 14:36:15 CET
 ************************************************************************************************/