...
package talenddemo.tfilecompare_0_1;
 ...
 * @status
 */
public class tfilecompare implements TalendJob {
	...
	private final String jobName = "tfilecompare";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tfilecompare.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
					...
					java.io.BufferedReader fileRef_tFileCompare_1 = new java.io.BufferedReader(
							new java.io.InputStreamReader(
									new java.io.FileInputStream(
											"/home/fitec/Talend/workspace/destination_folder/NewName.temp"),
									"ISO-8859-15"));
	...
	public static void main(String[] args) {
		final tfilecompare tfilecompareClass = new tfilecompare();

		int exitCode = tfilecompareClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tfilecompare.class.getClassLoader()
					.getResourceAsStream("talenddemo/tfilecompare_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = tfilecompare.class.getClassLoader()
		...
		} catch (TalendException e_tFileCompare_1) {
			globalMap.put("tFileCompare_1_SUBPROCESS_STATE", -1);

			e_tFileCompare_1.printStackTrace();
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tfilecompare");
		}
...
/************************************************************************************************
 * 25505 characters generated by Talend Open Studio for Data Integration on the
 * 19 novembre 2019 à 11:06:32 CET
 ************************************************************************************************/