...
package talenddemo.filter_row_0_1;
 ...
 * @status
 */
public class filter_row implements TalendJob {
	...
	private final String jobName = "filter_row";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(filter_row.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TALENDDEMO_filter_row = new byte[0];
		static byte[] commonByteArray_TALENDDEMO_filter_row = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDDEMO_filter_row.length) {
					if (length < 1024 && commonByteArray_TALENDDEMO_filter_row.length == 0) {
						commonByteArray_TALENDDEMO_filter_row = new byte[1024];
					} else {
						commonByteArray_TALENDDEMO_filter_row = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDDEMO_filter_row, 0, length);
				strReturn = new String(commonByteArray_TALENDDEMO_filter_row, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDDEMO_filter_row) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fileName_tFileOutputExcel_1 = "/home/fitec/Talend/workspace/output1400.xls";
...
//create directory only if not exists		  
				...
				util_tLogRow_1.addRow(
						new String[] { "identifiant", "nom", "prenom", "ville", "etat", "salaire", "errorMessage", });
...
// Start of branch "row1"
						if (row1 != null) {
							...
							ope_tFilterRow_1
									.matches(
											(row1.salaire == null ? false
													: row1.salaire.compareTo(
															ParserUtils.parseTo_Integer(String.valueOf(3000))) > 0),
											"salaire.compareTo(3000) > 0 failed");
...
///////////////////////		
								...
								if (row3.identifiant != null) { //
									row_tLogRow_1[0] = String.valueOf(row3.identifiant);
								...
								if (row3.prenom != null) { //
									row_tLogRow_1[2] = String.valueOf(row3.prenom);

								} //

								if (row3.ville != null) { //
									row_tLogRow_1[3] = String.valueOf(row3.ville);

								} //

								if (row3.etat != null) { //
									row_tLogRow_1[4] = String.valueOf(row3.etat);

								} //

								if (row3.salaire != null) { //
									row_tLogRow_1[5] = String.valueOf(row3.salaire);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final filter_row filter_rowClass = new filter_row();

		int exitCode = filter_rowClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = filter_row.class.getClassLoader()
					.getResourceAsStream("talenddemo/filter_row_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = filter_row.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : filter_row");
		}
...
/************************************************************************************************
 * 67492 characters generated by Talend Open Studio for Data Integration on the
 * 21 novembre 2019 à 11:00:48 CET
 ************************************************************************************************/