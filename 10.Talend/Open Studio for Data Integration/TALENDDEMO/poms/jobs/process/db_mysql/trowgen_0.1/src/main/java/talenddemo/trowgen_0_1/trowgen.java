...
package talenddemo.trowgen_0_1;
 ...
 * @status
 */
public class trowgen implements TalendJob {
	...
	private final String jobName = "trowgen";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(trowgen.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALENDDEMO_trowgen = new byte[0];
		static byte[] commonByteArray_TALENDDEMO_trowgen = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDDEMO_trowgen.length) {
					if (length < 1024 && commonByteArray_TALENDDEMO_trowgen.length == 0) {
						commonByteArray_TALENDDEMO_trowgen = new byte[1024];
					} else {
						commonByteArray_TALENDDEMO_trowgen = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDDEMO_trowgen, 0, length);
				strReturn = new String(commonByteArray_TALENDDEMO_trowgen, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDDEMO_trowgen) {
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fileName_tFileOutputExcel_1 = "/home/fitec/Talend/workspace/output_rowgen.xls";
...
//create directory only if not exists		  
				...
				class tRowGenerator_1Randomizer {
					public Integer getRandomuser_id() {
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					row1.user_id = randtRowGenerator_1.getRandomuser_id();
...
//modif ends							
	...
	public static void main(String[] args) {
		final trowgen trowgenClass = new trowgen();

		int exitCode = trowgenClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = trowgen.class.getClassLoader()
					.getResourceAsStream("talenddemo/trowgen_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = trowgen.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : trowgen");
		}
...
/************************************************************************************************
 * 34361 characters generated by Talend Open Studio for Data Integration on the
 * 20 novembre 2019 à 15:57:02 CET
 ************************************************************************************************/