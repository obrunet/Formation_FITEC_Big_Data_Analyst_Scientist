...
package talenddemo.tmysqlrow_0_1;
 ...
 * @status
 */
public class tmysqlRow implements TalendJob {
	...
	private final String jobName = "tmysqlRow";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tmysqlRow.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("ENC:[8CaOtDHmf80zhS60l7gM4e73SCw6AqOx3WQap9WK1kZNAMsH]");
	...
	public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				query_tDBRow_1 = "update user_details set username = 'Hamza' where user_id = 598";
	...
	public static void main(String[] args) {
		final tmysqlRow tmysqlRowClass = new tmysqlRow();

		int exitCode = tmysqlRowClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tmysqlRow.class.getClassLoader()
					.getResourceAsStream("talenddemo/tmysqlrow_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = tmysqlRow.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tmysqlRow");
		}
...
/************************************************************************************************
 * 30439 characters generated by Talend Open Studio for Data Integration on the
 * 20 novembre 2019 à 12:31:48 CET
 ************************************************************************************************/