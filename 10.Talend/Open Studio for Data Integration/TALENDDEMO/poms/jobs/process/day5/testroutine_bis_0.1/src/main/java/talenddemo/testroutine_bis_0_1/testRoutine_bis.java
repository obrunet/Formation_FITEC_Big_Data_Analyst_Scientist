...
package talenddemo.testroutine_bis_0_1;
...
/**
 * Job: testRoutine_bis Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class testRoutine_bis implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (contextlocal != null) {
				...
				this.setProperty("contextlocal", contextlocal.toString());
	...
	private final String jobName = "testRoutine_bis";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					testRoutine_bis.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(testRoutine_bis.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALENDDEMO_testRoutine_bis = new byte[0];
		static byte[] commonByteArray_TALENDDEMO_testRoutine_bis = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDDEMO_testRoutine_bis.length) {
					if (length < 1024 && commonByteArray_TALENDDEMO_testRoutine_bis.length == 0) {
						commonByteArray_TALENDDEMO_testRoutine_bis = new byte[1024];
					} else {
						commonByteArray_TALENDDEMO_testRoutine_bis = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDDEMO_testRoutine_bis, 0, length);
				strReturn = new String(commonByteArray_TALENDDEMO_testRoutine_bis, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDDEMO_testRoutine_bis) {
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fileName_tFileOutputExcel_1 = "/home/fitec/Talend/workspace/" + context.nom
						+ testRoutine.genereNameFile() + ".xls";
...
//modif ends							
	...
	public static void main(String[] args) {
		final testRoutine_bis testRoutine_bisClass = new testRoutine_bis();

		int exitCode = testRoutine_bisClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = testRoutine_bis.class.getClassLoader()
					.getResourceAsStream("talenddemo/testroutine_bis_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = testRoutine_bis.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("contextlocal", "id_String");
					context.contextlocal = (String) context.getProperty("contextlocal");
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("contextlocal")) {
				context.contextlocal = (String) parentContextMap.get("contextlocal");
			}
		}
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : testRoutine_bis");
		}
...
/************************************************************************************************
 * 33681 characters generated by Talend Open Studio for Data Integration on the
 * 22 novembre 2019 à 12:04:28 CET
 ************************************************************************************************/